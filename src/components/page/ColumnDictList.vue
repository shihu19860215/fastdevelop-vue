    ...
    <div class="table">
        ...
        <div class="container">
            ...
            <el-table :data="tableData" border class="table">
                ...
                <el-table-column prop="databaseValue" label="数据库值" >
                </el-table-column>
        ...
        <el-dialog title="编辑" :visible="editVisible" width="30%" :show-close=false>
            <el-form ref="form" :model="form" label-width="80px" :rules="rules">
                ...
                <el-form-item label="数据库值" prop="databaseValue">
                    <el-input v-model="form.databaseValue"></el-input>
                </el-form-item>
        ...
        data() {
            return {
                rules:{
                    ...
                    databaseValue:[
                        { required: true, message: '请输入数据库值', trigger: 'blur' },
